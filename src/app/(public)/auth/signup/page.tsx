...
import { Mail, Lock, User, Cpu } from 'lucide-react';
    ...
    <div className="min-h-[90vh] flex flex-col items-center justify-center p-4">
      ...
      <div className="glass-panel w-full max-w-md relative overflow-hidden flex flex-col pt-8 pb-10 px-8 border border-quantum-purple/40 shadow-glow-purple">
        <div className="text-center mb-8 space-y-2">
          ...
          <h3 className="text-2xl font-bold text-white tracking-wide">Begin Your Journey</h3>
          <p className="text-quantum-text-body text-sm">Create an account to track your progress.</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleSignUp}>
          ...
          <div className="space-y-4">
            <div className="relative">
              <User className="absolute left-3 top-3.5 w-5 h-5 text-quantum-text-body/60" />
              <input 
                type="text" 
        ...
        <div className="mt-6 text-center text-sm text-quantum-text-body">
          ...
          <Link href="/auth/signin" className="text-quantum-cyan hover:text-quantum-purple font-medium transition-colors">
            Log In
          </Link>
        </div>
      </div>
